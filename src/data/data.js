const data = [
  {
    // * Angie's Data (banner is an option choice, if you want to import one, paste it's url here!)* //
    firstName: undefined,
    lastName: undefined,
    role: undefined,
    story: undefined,
  ...
  {
    // * Bryant's Data (banner is an option choice, if you want to import one, paste it's url here!)* //
    firstName: 'Bryant',
    lastName: 'Mercedes',
    role: 'Co-Leader',
    story:
  ...
  {
    // * Bill's Data (banner is an option choice, if you want to import one, paste it's url here!)* //
    firstName: 'Bill',
    lastName: undefined,
    role: undefined,
    story: undefined,
  ...
  {
    // * Sev's Data (banner is an option choice, if you want to import one, paste it's url here!)* //
    firstName: 'Sara',
    lastName: 'Perkaj',
  ...
  {
    // * Melissa's Data (banner is an option choice, if you want to import one, paste it's url here!)* //
    firstName: undefined,
    lastName: undefined,
    role: undefined,
    story: undefined,
  ...
  {
    // * Dylan's Data (banner is an option choice, if you want to import one, paste it's url here!) * //
    firstName: 'Dylan',
    lastName: 'Lovell',
